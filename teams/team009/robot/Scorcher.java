...
public class Scorcher extends Manager {
    Info info;
    Direction myDir;
    MapLocation myLoc;
    MapLocation nextLoc;
    ...
    public Scorcher(RobotController rc) throws GameActionException {
    ...
    public void move(RobotController rc) throws GameActionException {
        ...
        if (rc.getFlux() < RobotType.SCORCHER.moveCost) {
            return;
        }
    ...
    private boolean attack(RobotController rc) throws GameActionException {
        ...
        if (rc.canAttackSquare(minLoc)) {
            ...
            return true;
        } else if (Info.distance(this.myLoc, minLoc) > 4) {
            return Move.moveTo(rc, this.myLoc, minLoc, this.myDir);
        } else {
            return Move.setDirection(rc, this.myLoc.directionTo(minLoc));
        }
    }
}
